...
import { ArrowRight, Star, Coffee, Wifi } from "lucide-react";
export default function HomePage() {
    return (<Layout>
      ...
      <section className="relative h-[80vh] w-full overflow-hidden">
        ...
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQG_uOlpoFvOvOmj2MI1ZumHcwSJXJo2uqRJA&s" alt="Luxury Hotel Lobby" className="w-full h-full object-cover"/>
      ...
      <section className="py-24 bg-background">
        ...
        ].map((feature, i) => (<div key={i} className="flex flex-col items-center text-center p-6 rounded-2xl hover:bg-muted/50 transition-colors duration-300">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="order-2 lg:order-1 relative">
              ...
              <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQF-Y1yiNfi0BYBVgZxihlLUp_ASHmR35CvEQ&s" alt="Luxury Suite" className="relative rounded-2xl shadow-2xl w-full h-[500px] object-cover"/>
            </div>
            ...
            "Exclusive Kitchen",
            "Self-Contain",
        ].map((item) => (<li key={item} className="flex items-center text-foreground font-medium">

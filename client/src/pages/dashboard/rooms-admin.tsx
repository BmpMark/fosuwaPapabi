...
export default function RoomsAdminPage() {
  ...
  const form = useForm<RoomFormData>({
    ...
    defaultValues: { isAvailable: true, type: "double", capacity: 2 },
  });
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 flex gap-8">
        ...
        <div className="flex-1 space-y-6">
          <div className="flex justify-between items-start">
            <div>
              <h1 className="font-display text-3xl font-bold mb-2">Room Management</h1>
              <p className="text-muted-foreground">Add and manage hotel rooms</p>
            </div>
                  ...
                  <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    <FormField control={form.control} name="description" render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl><Textarea placeholder="Room details and amenities..." {...field} /></FormControl>
                        <FormMessage />
                      </FormItem>
                    )} />

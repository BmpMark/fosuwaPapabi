        ...
        <div className="flex-1 space-y-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <Card className="w-full overflow-hidden">
              ...
              <CardContent>
                <div className="space-y-4">
                  {userReservations.length === 0 && (<p className="text-muted-foreground text-sm italic">No room charges found.</p>)}
                  {userReservations.map(r => (<div key={r.id} className="flex flex-col sm:flex-row justify-between border-b pb-2 gap-1">
            ...
            <Card className="w-full overflow-hidden">
              ...
              <CardContent>
                <div className="space-y-4">
                  {userOrders.length === 0 && (<p className="text-muted-foreground text-sm italic">No service charges found.</p>)}
                  {userOrders.map(o => (<div key={o.id} className="flex flex-col sm:flex-row justify-between border-b pb-2 gap-1">

  ...
  const submitOrder = () => {
    if (!selectedRoomId) {
      toast({
        variant: "destructive",
        title: "Select a Room",
        description: "Please select which room to deliver to.",
      });
      return;
    }
                ...
                {cart.length === 0 ? (
                  ...
                  <div className="space-y-4">
                    {cart.map((item) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <span>
                            $
                            {((menuItem.price * item.quantity) / 100).toFixed(
                              2,
                            )}
                          </span>
                        </div>
                    ...
                    <Button
                      className="w-full"
                      onClick={submitOrder}
                      disabled={createOrder.isPending || !selectedRoomId}
                    >

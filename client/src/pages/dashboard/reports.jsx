...
export default function ReportsPage() {
    const { data: rooms = [] } = useQuery({ queryKey: [api.rooms.list.path] });
    const { data: reservations = [] } = useQuery({ queryKey: [api.reservations.list.path] });
    const { data: orders = [] } = useQuery({ queryKey: [api.orders.list.path] });
    const { data: menuItems = [] } = useQuery({ queryKey: [api.menu.list.path] });
    // Calculate Occupancy
...
//# sourceMappingURL=reports.jsx.map
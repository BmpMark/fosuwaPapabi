  ...
  return (
    <Layout>
      ...
      <section className="relative h-[80vh] w-full overflow-hidden">
        ...
        <img
          src="https://lh3.googleusercontent.com/gps-cs-s/AG0ilSzvtz_gAUMWKnjrLmA42iq9oeLmocPmFUyIdtEe970wz_mpQ4bI5gSCsUOkc9UDUmzdWB2XH1Y43R7SiwIwvIBMj08cy6olqjvIL589iqMEl5UZhByRMCqaM5HhiZfWnVrDGnpR=s296-w296-h168-n-k-no-v1"
        ...
        <div className="absolute inset-0 z-20 flex flex-col items-center justify-center text-center px-4">
          ...
          <p className="text-lg md:text-xl text-white/90 max-w-2xl mb-10 leading-relaxed font-light drop-shadow-md">
            ...
            elegance meets timeless comfort in the heart of the town.
          </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-1 lg:order-2 space-y-8">
              ...
              <p className="text-muted-foreground text-lg leading-relaxed">
                Indulge in our most exclusive accommodation. Featuring panoramic
                city views, a private terrace, and a master bath with a soaking
